...
const WishlistBook = ({ wishlistBookObj }) => {
  const { bookName, image, author, totalPages, category, publisher, rating } = wishlistBookObj;
  return (
    <div className="hero">
...
WishlistBook.propTypes ={
  wishlistBookObj:PropTypes.object.isRequired,
}
